...
var app = {
    ...
    initialize: function() {
        ...
        try {
            ...
            this.storageManager.setPrintCountCallBack(function (count) {
                                  $('#sampleCount').html("Count: " + count);
                                  });
    ...
    onDeviceReady: function() {
        ...
        $('#training-selector').on('click', 'a', function(event) {
                                   ...
                                   Utils.showPopup("Set training label to " + button);
        ...
        $('#startBtn').bind('click', { parentObj: this }, function(e) {
                           ...
                           if ($(this).val() === 'Start') {
                                ...
                                $('#timeFrame').html("Start Time: " + Utils.formatTime(Utils.dateNow()));
                                app.stopWatch.isRunning = true;
                                app.getMeasure();
                                Utils.showPopup("Sensor monitoring started!");
                                console.log("Monitor thread set to running");
                           } else {
                            
                                $(this).changeButtonText('Start');
                                app.stopMonitoring();
                                Utils.showPopup("Sensor monitoring stopped.");
        ...
        $('#clearBtn').bind('click', { parentObj: this }, function(e) {
                            ...
                            if ($(this).val() === 'Clear') {
                                ...
                                Utils.showPopup("Local storage samples deleted!");
                                // Set the counter to zero
                                $('#sampleCount').html("Count: 0");
